...
import { History, Trash2, Link as LinkIcon } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {historyItems.length === 0 ? (
          <div className="text-center py-20 bg-slate-800/50 rounded-lg">
            ...
            <h2 className="text-2xl font-semibold mb-2">Tu historial está vacío</h2>
            <p className="text-gray-400 mb-6">Prueba una prenda en el probador virtual para verla aquí.</p>
            ...
            {historyItems.map((item) => (
              ...
              >
                <Link to={`/prenda/${item.id}`}>
                  ...
                  <div className="p-4">
                    <p className="font-semibold text-white truncate" title={item.nombre}>
                      {item.nombre}
                    </p>
                  </div>
                </Link>
